object TicTacToe5 extends App {
  ...
  import scala.io.StdIn.readLine
    ...
    /**
     * The following method makes a player move. Check if player's move has been made in the range of game, as well if the appropriate field has  been already taken, ask for another move.
